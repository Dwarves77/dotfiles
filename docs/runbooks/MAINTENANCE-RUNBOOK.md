...
`source_tier_opinions` row (`opinion_source: "host_class_table"`, migration 308) via `recordTierOpinion`
...
308_source_tier_opinions_host_class_table.sql` extends the `opinion_source` CHECK constraint (091) to
