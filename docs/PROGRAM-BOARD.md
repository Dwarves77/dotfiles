...
| **GATE-A-TOKENS (2026-09-04)** | Heal dry #34's strip plans showed gate A counting metadata stamps, boilerplate, headings and table rows as orphan figures (627 tokens); scanner fix in progress; the brief-honest strip stays undispatched until then | lane running; Addendum 85 ps 42 |
