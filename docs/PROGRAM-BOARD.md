...
| **NEXT** | Land the A1087 classification fix (branch upload → PR → merge under standing authority), dispatch dry (expect 6 products at week 2026-08-24), read the plan, apply, verify `market_series` non-empty + /market solid cards | Addendum 46 |
