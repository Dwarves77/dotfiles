...
| **RETEXT-COLLIDE (2026-09-04)** | Retext apply #35 hit `uq_item_forward_events_dedupe`: derived duplicates the index forbids are deleted (snapshotted) and the survivor rewritten | lane running; Addendum 85 ps 42 |
