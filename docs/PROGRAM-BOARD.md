...
| **NEXT (structural)** | one shared write-sequence module for canonical-pipeline.ts and apply-mint-batch.mjs (the gate-order bug was the cost of mirroring by hand) | postscript 11 |
