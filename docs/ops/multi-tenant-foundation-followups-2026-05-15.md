...
- [caros-ledge-supabase-schema-audit-2026-05-15](../audits/caros-ledge-supabase-schema-audit-2026-05-15.md) — Cited companion whose Corrections section and Section 6 recommendations drive the deferred integrity_flags and jurisdictions dispatches here
- [worktrees](../inventories/worktrees.md) — The three multi-tenant workstreams ran in the mt-A/B/C worktrees that landed as PRs #114/115/116 — the worktrees inventory records their disposition
