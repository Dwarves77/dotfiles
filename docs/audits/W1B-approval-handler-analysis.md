...
- [W4-backfill-plan](../plans/W4-backfill-plan.md) — This fix explicitly scopes re-materializing the existing 24 orphans to W4's per-orphan manual review
- [W1A-dual-write-audit](./W1A-dual-write-audit.md) — Wave-1a sibling; both touch staged_updates.proposed_changes as a write surface for the same materialization/dual-write effort
- [W1C-source-attribution-summary](./W1C-source-attribution-summary.md) — Wave-1a sibling audit feeding the same W4 recovery pass
