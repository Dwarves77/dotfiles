...
test("ALLOWED_FAMILIES is exactly mint, screen, fetch-drain, meta-harness, forward-events, source-sweep, propagation", () => {
  assert.deepEqual(ALLOWED_FAMILIES, ["mint", "screen", "fetch-drain", "meta-harness", "forward-events", "source-sweep", "propagation"]);
});
