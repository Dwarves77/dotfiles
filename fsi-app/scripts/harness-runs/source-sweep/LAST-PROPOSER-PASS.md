...
Per `PROPOSER-RUNBOOK.md` §2's attestation format. `source-sweep` now has **seventeen** artifacts
(`source-sweep-run-001` … `source-sweep-run-017`); F28's rule (d) requires this file to name the latest
verbatim: **source-sweep-run-017**.
