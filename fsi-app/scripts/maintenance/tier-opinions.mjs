...
// one opinion (`opinion_source: 'host_class_table'`, migration 308) with `opined_tier = classTier`
...
//
// migration 308 extends the `opinion_source` CHECK constraint (091) to add the `'host_class_table'`
...
export const CITE = Object.freeze({
  ...
  reason:
    ...
    "(opinion_source='host_class_table', migration 308) for every source whose host the SC-13 class " +
