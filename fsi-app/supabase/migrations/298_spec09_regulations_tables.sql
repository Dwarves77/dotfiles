-- subject: Migration 298 (SPEC-09, spec 09 section 1.8): `eudr_plot_claims` (`hold_risk` border_hold = blocking alert), `custody_chains` (`double_count_check`, retirement-needs-registry CHECK). RLS + authenticated SELECT. **APPLIED 2026-09-03** [CONFIRMED: 8/9 columns, RLS on, 0 rows].
