...
export const DUPLICATED_LINES_CEILING = 6216; // seeded 8061 on master ed2ee7c9 (lane L30); 7569 after L31 (route guard, 89 routes); re-seeded 6866 by lane L33 (community shell context, route skeleton frames); gitignored files excluded from the scan, CI parity, lane L33 second push (6866 to 6830); re-seeded by lane L34 after rebase onto master c5279274, detail and admin primitives (6830 to 6227); lane M5 after rebase onto master d3c2fb6f (6227 to 6216); only re-seed DOWN
