...
export const DOCTRINES = [
  ...
  },
  {
    ...
    source: 'operator RULING — preserve-not-overwrite (2026-07-16) + addendum (the over-clear incident, 2026-07-16): proof is per-condition evidence, not a proxy; automation executes a proven clearance, never infers it',
