...
export const INVARIANTS = [
...

  {
    ...
    enforcedBy: ['selftest:fsi-app/scripts/verify/non-destructive-grounding.golden.mjs', 'selftest:fsi-app/scripts/verify/drain-clear-two-condition.golden.mjs', 'migration:208'],
