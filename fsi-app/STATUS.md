...
4. **Regulation detail count discrepancy.** User scope says "5 sections of the brief structure as currently designed" with "additional 5 brief sections to bring the structure to 10" deferred. Preview as-currently-designed has 7 panels (Summary, Exposure, Penalty calculator, Timeline, Full text, Sources, Team notes). Confirm before regulation-detail migration whether to ship all 7 visible panels per the preview, or treat Sources + Team notes as part of the deferred 5.
