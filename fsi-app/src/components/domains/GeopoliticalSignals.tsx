...
const MARKET_SIGNALS: MarketSignal[] = [
  {
    ...
    indicators: [
      { name: "Brent crude", what_it_measures: "International crude oil benchmark price per barrel, used to set bunker fuel costs for ocean shipping globally", unit: "USD/barrel", update_frequency: "Daily", data_provider: "US Energy Information Administration", data_url: "https://www.eia.gov/dnav/pet/pet_pri_spt_s1_d.htm", trend: "volatile", why_it_matters: "Directly determines bunker fuel surcharges on every ocean freight invoice. A $10/bbl move translates to roughly $15-25 per TEU on major trade lanes." },
      { name: "Jet fuel (Singapore)", what_it_measures: "Kerosene-type jet fuel spot price at Singapore hub — benchmark for Asia-Pacific air cargo fuel surcharges", unit: "USD/gallon", update_frequency: "Daily", data_provider: "US Energy Information Administration", data_url: "https://www.eia.gov/dnav/pet/pet_pri_spt_s1_d.htm", trend: "volatile", why_it_matters: "Sets the fuel surcharge for all air cargo moving through Asia-Pacific. Singapore MOPS is the reference price for most Asian carriers." },
      { name: "Jet fuel (NWE)", what_it_measures: "Kerosene-type jet fuel spot price at Northwest Europe hub — benchmark for European air cargo fuel surcharges", unit: "USD/gallon", update_frequency: "Daily", data_provider: "US Energy Information Administration", data_url: "https://www.eia.gov/dnav/pet/pet_pri_spt_s1_d.htm", trend: "volatile", why_it_matters: "Reference price for European carrier fuel surcharges. Transatlantic and intra-European air cargo rates index to this." },
      { name: "Jet fuel (US Gulf)", what_it_measures: "Kerosene-type jet fuel spot price at US Gulf Coast — benchmark for US domestic and Americas air cargo", unit: "USD/gallon", update_frequency: "Daily", data_provider: "US Energy Information Administration", data_url: "https://www.eia.gov/dnav/pet/pet_pri_spt_s1_d.htm", trend: "volatile", why_it_matters: "Sets the fuel surcharge for US domestic air freight and Americas outbound cargo." },
    ],
    active_risks: [
  ...
  },
  {
    ...
    indicators: [
      { name: "EU ETS (EUA)", what_it_measures: "Price per tonne of CO2 under the EU Emissions Trading System — the carbon cost carriers must surrender for EU maritime and aviation emissions", unit: "EUR/tCO2", update_frequency: "Quarterly (ICAP report), daily via exchanges", data_provider: "ICAP Allowance Price Explorer", data_url: "https://icapcarbonaction.com/en/ets-prices", trend: "volatile", why_it_matters: "Maritime ETS: carriers surrender EUAs for EU port-to-port and 50% of inbound/outbound voyages. This cost is passed through as a carbon surcharge on every ocean shipment touching EU ports." },
      { name: "UK ETS (UKA)", what_it_measures: "Price per tonne of CO2 under the UK Emissions Trading System — separate from EU ETS post-Brexit", unit: "GBP/tCO2", update_frequency: "Quarterly", data_provider: "ICAP Allowance Price Explorer", data_url: "https://icapcarbonaction.com/en/ets-prices", trend: "volatile", why_it_matters: "UK aviation and maritime carbon cost. Different price from EU ETS — creates split surcharge structures on UK vs EU routes." },
      { name: "California (CCA)", what_it_measures: "Price per tonne of CO2 under the California Cap-and-Trade Program — affects CARB-regulated trucking fleets", unit: "USD/tCO2", update_frequency: "Quarterly", data_provider: "ICAP Allowance Price Explorer", data_url: "https://icapcarbonaction.com/en/ets-prices", trend: "up", why_it_matters: "Trucking operators in California and Section 177 states face carbon costs that flow through to drayage and last-mile delivery rates." },
      { name: "Korea ETS (KAU)", what_it_measures: "Price per tonne of CO2 under the Korean Emissions Trading Scheme — Asia's largest carbon market", unit: "KRW/tCO2", update_frequency: "Quarterly", data_provider: "ICAP Allowance Price Explorer", data_url: "https://icapcarbonaction.com/en/ets-prices", trend: "stable", why_it_matters: "Affects carbon exposure on Korea trade lanes. Korean carriers may pass through costs as fleet decarbonization accelerates." },
      { name: "Singapore carbon tax", what_it_measures: "Fixed carbon tax per tonne of CO2 on facilities emitting 25,000+ tCO2/year — rising trajectory legislated", unit: "SGD/tCO2", update_frequency: "Annual (legislated schedule)", data_provider: "Singapore Government", data_url: "https://www.greenplan.gov.sg/", trend: "up", why_it_matters: "Currently S$25/tCO2e, rising to S$50-80 by 2030. Affects warehouse and port facility costs in Singapore. Signal for broader ASEAN carbon pricing." },
    ],
    active_risks: [
  ...
  },
  {
    ...
    indicators: [
      { name: "Propylene", what_it_measures: "Feedstock price for polypropylene — used in strapping, containers, protective packaging, and pallet wrapping", unit: "USD/tonne", update_frequency: "Weekly (ICIS), quarterly averages", data_provider: "ICIS / S&P Global Platts", data_url: "https://www.icis.com/explore/commodities/chemicals/propylene/", trend: "stable", why_it_matters: "When propylene rises, the cost of protective packaging, strapping, and plastic crating materials rises across all freight sectors." },
      { name: "Ethylene", what_it_measures: "Feedstock price for polyethylene — used in stretch film, bubble wrap, foam inserts, and poly bags", unit: "USD/tonne", update_frequency: "Weekly (ICIS), quarterly averages", data_provider: "ICIS / S&P Global Platts", data_url: "https://www.icis.com/explore/commodities/chemicals/ethylene/", trend: "stable", why_it_matters: "PE film and foam are in virtually every shipment. Price moves affect packaging costs industry-wide." },
      { name: "Methanol", what_it_measures: "Price of methanol — both a marine fuel alternative (green methanol) and a feedstock for adhesives and coatings used in packaging", unit: "USD/tonne", update_frequency: "Weekly (ICIS), quarterly averages", data_provider: "ICIS / S&P Global Platts", data_url: "https://www.icis.com/explore/commodities/chemicals/methanol/", trend: "up", why_it_matters: "Dual relevance: rising methanol demand for maritime fuel (green methanol vessels on order) AND packaging material input costs." },
    ],
    active_risks: [
  ...
  },
  {
    ...
    indicators: [
      { name: "Lithium carbonate", what_it_measures: "Price of battery-grade lithium carbonate — the primary cost driver for lithium-ion batteries used in EVs and energy storage", unit: "USD/tonne", update_frequency: "Weekly spot, quarterly contract", data_provider: "IRENA / Bloomberg", data_url: "https://www.irena.org/Energy-Transition/Technology/Power-generation-costs", trend: "down", why_it_matters: "Lithium cost decline drives EV and BESS affordability. When battery costs drop, fleet electrification becomes viable sooner — affecting trucking fleet transition timelines." },
      { name: "Cobalt", what_it_measures: "Price of cobalt — used in NMC battery cathodes. Industry is shifting to cobalt-free LFP chemistry but cobalt remains in high-energy-density applications", unit: "USD/lb", update_frequency: "Daily (LME), quarterly averages", data_provider: "IRENA / Bloomberg", data_url: "https://www.irena.org/Energy-Transition/Technology/Power-generation-costs", trend: "down", why_it_matters: "Cobalt price and supply concentration (60%+ from DRC) affect EV battery costs and create ethical sourcing pressure for fleet procurement." },
      { name: "Nickel", what_it_measures: "Price of Class 1 nickel — used in high-energy NMC batteries and stainless steel (container construction)", unit: "USD/tonne", update_frequency: "Daily (LME)", data_provider: "IRENA / Bloomberg", data_url: "https://www.irena.org/Energy-Transition/Technology/Power-generation-costs", trend: "volatile", why_it_matters: "Dual impact: battery costs for EV transition AND stainless steel costs for container and equipment manufacturing." },
    ],
    active_risks: [
  ...
  },
  {
    ...
    indicators: [
      { name: "Strait of Hormuz", what_it_measures: "Daily tanker and cargo vessel transits through the 21-mile-wide strait between Iran and Oman — 20% of global oil supply passes through here", unit: "Vessels/day", update_frequency: "Real-time (AIS data)", data_provider: "MarineTraffic", data_url: "https://www.marinetraffic.com", trend: "volatile", why_it_matters: "Any disruption here spikes oil prices within hours and reroutes Persian Gulf trade lanes around the Cape of Good Hope, adding 10-15 days transit time." },
      { name: "Suez Canal", what_it_measures: "Daily transits through the Suez Canal — the primary Asia-Europe shipping corridor handling 12-15% of global trade", unit: "Vessels/day", update_frequency: "Real-time (AIS data)", data_provider: "MarineTraffic / Suez Canal Authority", data_url: "https://www.marinetraffic.com", trend: "stable", why_it_matters: "Disruption forces Cape of Good Hope routing: +7-10 days transit, +$1M fuel per voyage for large vessels. Directly affects Asia-Europe freight rates and schedules." },
      { name: "Panama Canal drafts", what_it_measures: "Maximum vessel draft allowed through Panama Canal locks — restricted during drought, affecting vessel capacity on Americas trade lanes", unit: "Feet (draft restriction)", update_frequency: "Daily (ACP announcements)", data_provider: "Panama Canal Authority", data_url: "https://pancanal.com/en/", trend: "stable", why_it_matters: "Draft restrictions force vessels to lighten loads or reroute via Suez/Cape Horn. Affects US East Coast ↔ Asia capacity and rates. 2023-24 drought cut daily transits by 36%." },
    ],
    active_risks: [
