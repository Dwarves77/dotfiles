...
/**
 * /community/events — static stub for Phase C.
 *
 * Moved from /events to /community/events as part of PR-D IA refactor
 * (2026-05-06). The original /events route now 308-redirects here.
 *
